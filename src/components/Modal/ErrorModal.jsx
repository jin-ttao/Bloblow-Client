      ...
      <ModalBackground isClear={false} modalType={MODAL_TYPE.ERROR}>
        <ModalFrame isClear={false} hasCloseButton={false} modalType={MODAL_TYPE.ERROR}>
          <main className="flex flex-col gap-15 items-center">
            <h1 className="md:text-18 text-16 text-red-700">{errorMessage}</h1>
            <Button
              type="button"
              styles="flex-center md:px-14 md:py-6 px-10 py-4 font-medium border-2 border-slate-700 bg-red-500/10 rounded-[5px] text-14 hover:bg-red-500/20"
